...
import (
	...
	httpdto "github.com/iPatrushevSergey/metrics/metrics_new/app/internal/agent/collector/adapters/metrics_client/dto"
...
func (c *Client) metricsUpdateBatchPrepare(metrics []dto.MetricUpdateInput) (preparedRequest, error) {
...
func (c *Client) metricsUpdateBatchSend(ctx context.Context, prepReq preparedRequest) (*http.Response, error) {
...
func (c *Client) metricsUpdateBatchProcessResponse(resp *http.Response) error {
	var (
