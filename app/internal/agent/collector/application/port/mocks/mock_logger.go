...
// Source: internal/agent/collector/application/port/logger.go
//
// Generated by this command:
//
//	mockgen -source=internal/agent/collector/application/port/logger.go -destination=internal/agent/collector/application/port/mocks/mock_logger.go -package=mocks
//
