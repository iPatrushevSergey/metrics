...
// Source: internal/server/metrics/application/port/logger.go
//
// Generated by this command:
//
//	mockgen -source=internal/server/metrics/application/port/logger.go -destination=internal/server/metrics/application/port/mocks/mock_logger.go -package=mocks
//
